...
Standalone copy so this tool runs independently of its sibling scrapers.
"""
...
log = logging.getLogger("labagents.http")

DEFAULT_UA = (
    "Mozilla/5.0 (compatible; SDLabAgentsBot/1.0; +https://example.com/bot-info)"
)
