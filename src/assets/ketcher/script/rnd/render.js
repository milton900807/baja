...
rnd.Render.prototype.observe = function ( target, handler) {
	this.clientArea.observe ( target, handler );
};
...
rnd.Render.prototype.addStructChangeHandler_ = function (handler)
{
	if (handler in this.structChangeHandlers)
		throw new Error('handler already present');
	this.structChangeHandlers.push(handler);
...
rnd.Render.prototype.clientAreaObject = function (v, isRelative) {
